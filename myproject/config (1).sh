...
SOURCE="https://liveeu-gcp.alkassdigital.net:443/alkass1-p/20251112T070231Z/mux_video_1080p_ts/index-1.m3u8"
...
#
LOGO_OFFSET_X="-27"     # 5 بكسل من الحافة اليمنى (ملتصق تقريباً)
